...
__Graphic__: This is an animation of how the __predictions__ of a model change as it is __trained__. Visit the repository to see the same animation for a less naive model that respects symmetry.
